...
<html lang="zh-CN">
  ...
  <body>
    ...
    <!-- Container -->
    <div class="contaner">
      <div class="empty" style="margin-top:10%">
       <center>
        <font style="font-size:50px">Hi,<%= session.getAttribute("realname")%></font><br>
        <font style="font-size:50px;font-family:微软雅黑">你还没有添加联系人，</font><br>
        <font style="font-size:50px;font-family:微软雅黑""><a href="newcontact.jsp">点击这里</a>开始添加联系人。</font> 
       </center>
       </div>
    </div>
