...
public class DeleteContactServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean flag = contactdao.deleteContact(cid);
		if(flag == true){
			out.println("<script>alert('联系人删除成功');window.location.href=('MainServlet');</script>");
		}else{
			out.println("<script>alert('联系人删除失败');window.location.href=('MainServlet');</script>");
		}
	}
